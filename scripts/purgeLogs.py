...
# Parse a timestamp from various supported fields and normalize to naive datetime
...
# Return the most recent timestamp for a given IP from the logs collection
