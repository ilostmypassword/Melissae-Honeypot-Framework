  ...
  if (error) {
    return (
      <div className="bg-verdict-malicious/10 border border-verdict-malicious/30 text-verdict-malicious rounded-xl p-6 text-center">
        ...
        <div className="text-sm mt-1 opacity-75">{error}</div>
      </div>
    )
  }
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-surface-secondary rounded-xl border border-border p-4">
          <p className="text-xs text-text-muted uppercase tracking-wider">Total IPs</p>
          <p className="text-2xl font-semibold text-text-primary font-mono mt-1">{threats.length}</p>
        </div>
        <div className="bg-surface-secondary rounded-xl border border-border p-4">
          <p className="text-xs text-text-muted uppercase tracking-wider">External (Public)</p>
          <p className="text-2xl font-semibold text-protocol-http font-mono mt-1">{geoThreats.length}</p>
        </div>
        <div className="bg-surface-secondary rounded-xl border border-border p-4">
          <p className="text-xs text-text-muted uppercase tracking-wider">Internal (Private)</p>
